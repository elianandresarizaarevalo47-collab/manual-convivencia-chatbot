...
La sanción de la Ley 1620, promulgada el 15 de marzo de 2013, y la expedición del Decreto reglamentario 1965 del 11 de septiembre de 2013, introducen el concepto de formación para los derechos humanos, la educación para la sexualidad y la prevención y mitigación de la violencia escolar, cuyos propósitos serán cumplidos "a través de la promoción, orientación y coordinación de estrategias, programas y actividades, en el marco de la corresponsabilidad de las personas, las instituciones educativas, la familia, la sociedad y el Estado" (Ley 1620, Art. 3).

La política institucional para la inclusión y el buen trato nos pone en línea directa con lo establecido por los dictámenes legales enunciados y conlleva que toda la Comunidad Educativa conozca, analice y se sensibilice en todo lo que conlleva dicha política y garantice, mediante prácticas cotidianas, un cabal cumplimiento de la normatividad establecida.

En ese sentido, la Institución Educativa Delicias San Carlos asume un mayor compromiso para incentivar el estudio y la apropiación de las competencias ciudadanas, entendidas como el conjunto de conocimientos y habilidades cognitivas, emocionales y comunicativas que, articulados entre sí, hacen posible la consolidación de una cultura inclusiva y la prevención y mitigación de la violencia escolar.

La educación para el ejercicio de los derechos humanos, sexuales y reproductivos se entiende como aquella orientada a formar personas capaces de reconocerse como sujetos activos titulares de derechos humanos, sexuales y reproductivos, con los cuales desarrollarán competencias para contribuir positivamente a la construcción de su proyecto de vida, la transformación de dinámicas sociales y el establecimiento de relaciones más justas, democráticas y responsables.`
},
{
...
Es el mecanismo institucional mediante el cual se establecen los protocolos que se deben activar en todos los casos en que se vea afectada la convivencia y los derechos humanos, sexuales o reproductivos de los estudiantes, articulando una oferta de servicio ágil, integral y complementaria. El sistema garantizará la atención inmediata y pertinente de los casos de violencia escolar, acoso o vulneración de derechos sexuales y reproductivos que se presenten en el establecimiento o en sus alrededores y que involucren a cualquier estudiante, así como el embarazo adolescente.

Habrá un componente de promoción y de prevención como parte del plan integral de formación contemplado en el P.E.I., operacionalizado en el Plan de Estudios. Las direcciones de curso y la Psicorientación serán escenarios fundamentales para las actividades de promoción y prevención.

En concordancia con lo dictado en el Decreto 1965, las situaciones que afecten el clima escolar o los DHSR se tipifican en tres categorías:

SITUACIONES TIPO I: corresponden a conflictos manejados inadecuadamente y/o situaciones esporádicas que inciden negativamente en el clima escolar y que, en ningún caso, generan daños al cuerpo o a la salud. Se tipifican: las riñas o peleas simples, daños en propiedad ajena, agresión verbal, fumar, consumir sustancias prohibidas, vandalismo y embarazo adolescente.

SITUACIONES TIPO II: corresponden a situaciones de agresión escolar, acoso (bullying) y acoso en redes sociales de Internet (ciberbullying), que no revistan las características de la comisión de un delito, que se presenten de manera repetida o sistemática y/o que causen daño al cuerpo o a la salud sin generar incapacidad alguna para los involucrados. Además, incluyen las situaciones de consumo de sustancias psicoactivas.

SITUACIONES TIPO III: corresponden a las situaciones de agresión escolar que sean constitutivas de presuntos delitos contra la libertad, integridad física y/o formación sexual, o cuando constituyen cualquier otro delito establecido en la ley penal colombiana vigente.

Incluye: agresión física con lesiones personales, distribución de sustancias prohibidas, agresión sexual, porte de armas, extorsión, agiotismo, robo, casos de violencia intrafamiliar y violencia sexual (Decreto 1965, Art. 40).

Cualquier miembro de la comunidad educativa u otra persona en condición de conocido, vecino, amigo, familiar, etc., está en su derecho y a la vez en la obligación de informar a cualquier autoridad escolar y por cualquier medio (oral, escrito, por plataforma) sobre cualquier situación que, a su buen saber y entender, esté afectando la convivencia o los DHSR de un miembro de la comunidad educativa, particularmente si es estudiante.`
},
{
    titulo: "Glosario. Conceptos sobre convivencia y agresión escolar",
    palabras: [
        "glosario",
        "conflictos",
...
Agresión física: Es toda acción que tenga como finalidad causar daño al cuerpo o a la salud de otra persona. Incluye patadas, empujones, cachetadas, mordiscos, rasguños, pellizcos, puñetazos, jalones de pelo, entre otras acciones.
...
Acoso escolar (bullying): De acuerdo con el artículo 2 de la Ley 1620 de 2013, es toda conducta negativa, intencional, metódica y sistemática de agresión, intimidación, humillación, ridiculización, difamación, coacción, aislamiento deliberado, amenaza o incitación a la violencia, o cualquier forma de maltrato psicológico, verbal, físico o por medios electrónicos contra un niño, niña o adolescente, por parte de un estudiante o varios de sus pares con quienes mantiene una relación de poder asimétrica. Se presenta de forma reiterada o a lo largo de un tiempo determinado. También puede ocurrir por parte de docentes contra estudiantes, o por parte de estudiantes contra docentes, ante la indiferencia o complicidad de su entorno.

Ciberacoso escolar (ciberbullying): De acuerdo con el artículo 2 de la Ley 1620 de 2013, es toda forma de intimidación con uso deliberado de tecnologías de información, como Internet, redes sociales virtuales, telefonía móvil y videojuegos en línea, para ejercer maltrato psicológico y continuado.

Homofobia: Hace referencia a la aversión contra hombres o mujeres homosexuales. Generalmente, también se incluyen las personas que integran la diversidad sexual, como las personas bisexuales y transexuales, así como aquellas que presentan actitudes o hábitos comúnmente asociados al otro sexo.

Protocolo: Es un plan escrito y detallado de las acciones y estrategias concretas que se van a llevar a cabo en el establecimiento educativo para responder a las situaciones que se presenten en los tres niveles de atención.
...
{
    titulo: "Artículo Catorce. Procesos disciplinarios y principios orientadores",
    palabras: [
        "artículo catorce",
        "articulo catorce",
        "catorce",
        "procesos disciplinarios",
        "proceso disciplinario escolar",
        "principios orientadores",
        "función del proceso disciplinario",
        "funcion del proceso disciplinario",
        "dignidad humana",
        "buena fe",
        "legalidad",
        "debido proceso",
    ...
    contenido: `Artículo Catorce. Procesos disciplinarios y principios orientadores.
...
Reconocimiento de la dignidad humana: Todo estudiante o miembro de la Comunidad Educativa que se relacione con la Institución Educativa Delicias San Carlos y a quien le sea atribuida una situación Tipo I, Tipo II o Tipo III, tiene derecho a ser tratado con el respeto debido a su dignidad como ser humano.

Buena fe: Siempre debe presumirse la buena fe en la conducta del estudiante sujeto de acción correctiva.

Legalidad: Como miembro de la comunidad educativa, todo estudiante sólo será investigado y tratado por comportamientos descritos como situaciones disciplinarias en el Manual vigente en el momento de la realización u omisión del hecho reprochado.

Debido proceso: Al estudiante le serán aplicadas las normas atinentes al caso atribuido, ante quien sea competente según lo previamente establecido, observando las formas propias de la Constitución, la Ley y el presente Manual de Convivencia.

Culpabilidad: Cuando sea necesario llevar un proceso disciplinario-pedagógico, se excluye toda forma de responsabilidad objetiva. En cualquier caso, las acciones sólo serán sancionables a título de dolo o culpa.

Igualdad: Todos los alumnos recibirán la misma protección y trato por parte de la Institución Educativa Delicias San Carlos, y tendrán los mismos derechos, libertades y oportunidades sin ninguna discriminación por su edad, raza, origen nacional o familiar, lengua, credo, opinión política o filosófica.

Finalidad de las funciones disciplinarias-pedagógicas: El Manual de Convivencia garantiza el cumplimiento de los fines y funciones propuestas por la Institución Educativa Delicias San Carlos en relación con el comportamiento de sus alumnos cuando éste los afecte o ponga en peligro dicho cumplimiento.

Finalidad de las estrategias formativas y/o medidas disciplinarias: Cumplen esencialmente los fines estrictamente pedagógicos, de prevención y formación en valores, o la extinción de comportamientos que contraríen el proceso de aprendizaje propio y ajeno.

Derecho a la defensa: El alumno que sea objeto de una investigación disciplinaria tiene derecho a conocer la queja y las pruebas que se alleguen a la investigación; a que se practiquen las pruebas que solicite, a ser escuchado en su versión libre y espontánea, y a rendir sus descargos, para lo cual puede estar acompañado de sus padres o acudientes, y a interponer el recurso de reposición sobre la decisión tomada.

Proporcionalidad: La sanción disciplinaria debe corresponder al grado de valoración de la acción cometida, según sea ésta Tipo I, II o III. Al graduar la acción disciplinaria se deben aplicar los criterios contenidos en este Manual de Convivencia.

Motivación: Toda decisión debe ser motivada. Las estrategias formativas y/o medidas disciplinarias que se apliquen deben contener una sustentación adecuada a su finalidad pedagógica y formativa.
...
Medidas contra el abuso de los derechos y el incumplimiento de los deberes: El estudiante que abuse de sus derechos, incumpla sus deberes o compromisos e incurra en situaciones disciplinarias, se hará acreedor a una estrategia formativa o medida correctiva.`
},
{
    titulo: "Artículo Catorce. Procesos disciplinarios y principios orientadores (continuación)",
    palabras: [
        "artículo catorce",
        "articulo catorce",
        "catorce",
...
Protección de los derechos e intereses de la comunidad educativa (Bien Común): El ejercicio de los derechos de los educandos, de sus padres o acudientes autorizados, supone la responsabilidad frente a los derechos de los demás alumnos y de cada uno de los estamentos que componen la comunidad educativa de la Institución.

Participación: Todos los alumnos y sus padres o acudientes tienen derecho a ser escuchados y solicitar pruebas en el momento de encontrarse en un proceso de análisis comportamental.
...
Potestad disciplinaria: De conformidad con el literal "g" del Artículo 25 del Decreto 1860 de 1994, la función disciplinaria en los establecimientos educativos corresponde al Rector o a quien éste la delegue.`
},
{
    titulo: "Artículo Quince. Acciones tipificadas como situaciones Tipo I",
    palabras: [
        "artículo quince",
        "articulo quince",
        "quince",
        ...
        "compromisos academicos",
        "elementos tecnológicos",
        "elementos tecnologicos",
        "conducto regular",
        "vocabulario inadecuado"
    ],
    contenido: `Artículo Quince. Acciones tipificadas como situaciones Tipo I.
...
{
    titulo: "Artículo Dieciséis. Ruta de atención para situaciones Tipo I",
    palabras: [
        "artículo dieciséis",
        "articulo dieciseis",
        "dieciséis",
    ...
    contenido: `Artículo Dieciséis. Ruta de atención para situaciones Tipo I.
...
3. La Coordinación de Convivencia toma nota de la situación correspondiente. Si el caso es de embarazo adolescente, se comunica al Departamento de Orientación y éste toma el control del asunto, y se informa de la situación al Hospital y/o al ICBF.

4. El(la) Director(a) de curso informa del caso a Coordinación de Convivencia. El caso entra a formar parte del cronograma de acompañamiento, del cual harán parte Orientación y el Coordinador.

5. Se informa a los padres de familia. Se deja acta al respecto que reposa en Coordinación de Convivencia.

6. Se informa al Rector sobre la evolución del proceso.

7. Cierre del caso.`
},
{
    titulo: "Artículo Diecisiete. Protocolo a seguir por parte de la institución",
    palabras: [
        "artículo diecisiete",
        "articulo diecisiete",
        "diecisiete",
    ...
    contenido: `Artículo Diecisiete. Protocolo a seguir por parte de la institución.
...
{
    titulo: "Artículo Dieciocho. Acciones preventivas y/o correctivas a tomar para situaciones Tipo I",
    palabras: [
        "artículo dieciocho",
        "articulo dieciocho",
        "dieciocho",
    ...
    contenido: `Artículo Dieciocho. Acciones preventivas y/o correctivas a tomar para situaciones Tipo I.
...
{
    titulo: "Artículo Diecinueve. Acciones tipificadas como situaciones Tipo II",
    palabras: [
        "artículo diecinueve",
        "articulo diecinueve",
        "diecinueve",
        ...
        "irrespeto a directivos"
    ],
    contenido: `Artículo Diecinueve. Acciones tipificadas como situaciones Tipo II.
...
• Irrespeto con palabras obscenas contra un docente o directivo.`
},
{
    titulo: "Artículo Veinte. Protocolo a seguir por parte de la institución",
    palabras: [
        "artículo veinte",
        "articulo veinte",
        "veinte",
    ...
    contenido: `Artículo Veinte. Protocolo a seguir por parte de la institución.
...
• Citar, por parte del docente, dirección de grupo o coordinación, al acudiente para ponerle en conocimiento la situación y formalizar un compromiso para ayudar a mejorar al estudiante.
...
{
    titulo: "Artículo Veintiuno. Ruta de atención para situaciones Tipo II",
    palabras: [
        "artículo veintiuno",
        "articulo veintiuno",
        "veintiuno",
    ...
    contenido: `Artículo Veintiuno. Ruta de atención para situaciones Tipo II.
...
• Realizar anotaciones en el Observador del estudiante.

• Realizar llamado al padre de familia.

• Realizar acciones pedagógicas y firma de compromiso por parte del director de grupo, estudiante y padre de familia. Remisión al departamento de orientación escolar.
...
• El Comité realizará el análisis y seguimiento, a fin de verificar si la solución fue efectiva o si se requiere acudir al protocolo consagrado en la situación Tipo III.
...
{
    titulo: "Artículo Veintidós. Acciones preventivas y/o correctivas a tomar para situaciones Tipo II",
    palabras: [
        "artículo veintidós",
        "articulo veintidos",
        "veintidós",
    ...
    contenido: `Artículo Veintidós. Acciones preventivas y/o correctivas a tomar para situaciones Tipo II.

• Fomentar espacios en los que los miembros de la comunidad educativa puedan expresar sus puntos de vista sobre la situación, como conciliación y concertación, aplicando el principio de confidencialidad y respeto a la intimidad de los temas que allí se traten para dar un manejo ético y cuidadoso de la situación.

• Reconocer el tipo de situación, su recurrencia y los daños que puede ocasionar.
...

{
    ...
    contenido: `Artículo Veintitrés. Acciones tipificadas como situaciones Tipo III.
...
• Inducción, porte, distribución o intento de distribución de sustancias sicotrópicas o alucinógenas que causen adicción.

• Ingerir bebidas alcohólicas, sustancias alucinógenas o sustancias sicotrópicas que causen adicción dentro o fuera de la Institución, en actividades institucionales, y el ingreso de las mismas a la institución.

• Ejecutar dentro o fuera de la Institución actos que atenten contra la moral y la dignidad de la persona y los principios de la Institución, incluyendo las conductas sexuales delictivas mencionadas en el Manual.

• Realizar o encubrir actos que atenten contra la comunidad educativa, tales como explotación económica y laboral, maltrato físico o psicológico, abuso o acoso sexual, discriminación por edad, sexo, raza, religión, política, posición social, lugar de vivienda y tráfico de estupefacientes, de acuerdo con el artículo 44, numeral 2, del Código de Infancia y Adolescencia.

• Atentar contra el derecho a la vida y/o la paz mediante actos tales como amenazas, boleteo, estafas, chantajes, lesiones personales o abuso de confianza por cualquier medio electrónico, físico u otros.
...
{
    titulo: "Artículo Veinticuatro. Protocolo para la atención de situaciones Tipo III",
    palabras: [
    ...
    contenido: `Artículo Veinticuatro. Protocolo para la atención de situaciones Tipo III.

Parágrafo 1: El Comité Escolar de Convivencia activará la Ruta de Atención Integral (RAI) para que brinden atención inmediata a la víctima, a quien se le atribuye la agresión y a las personas que hayan informado o hagan parte de la situación presentada, para brindarles protección dentro y fuera de la Institución.

• En casos de daño al cuerpo o a la salud, garantizar la atención inmediata en salud física y mental de los involucrados, mediante la remisión a las entidades competentes. De esta actuación se dejará constancia.

• Informar de manera inmediata a los padres, madres o acudientes de todos los estudiantes involucrados. De esta actuación se dejará constancia.

• El presidente del Comité Escolar de Convivencia, de manera inmediata y por el medio más expedito, pondrá la situación en conocimiento de la Policía Nacional, Policía de Infancia y Adolescencia, Personería, ICBF y entidades de salud mental. De esta actuación se dejará constancia.

• Se citará a los integrantes del Comité Escolar de Convivencia en los términos fijados en el Manual de Convivencia.

• El presidente del Comité Escolar de Convivencia informará a los participantes del Comité sobre los hechos que dieron lugar a la convocatoria, guardando reserva de aquella información que pueda atentar contra el derecho a la intimidad y confidencialidad de las partes involucradas, así como del reporte realizado ante la autoridad competente.

• Pese a que una situación se haya puesto en conocimiento de las autoridades competentes, el Comité Escolar de Convivencia adoptará de manera inmediata las medidas propias del establecimiento educativo, tendientes a proteger, dentro del ámbito de sus competencias, a la víctima, a quien se le atribuye la agresión y a las personas que hayan informado o hagan parte de la situación presentada. De esta actuación se dejará constancia.
...
{
    titulo: "Artículo Veinticinco. Protocolo a seguir por parte de la institución",
    palabras: [
    ...
    contenido: `Artículo Veinticinco. Protocolo a seguir por parte de la institución.

Las situaciones Tipo III conllevan los siguientes correctivos por parte de la Institución:

• Anotación inmediata en el Observador por parte del docente o coordinador que haya conocido u observado la situación. La anotación debe ser firmada por los estudiantes, aceptándola o rechazándola. En caso de rechazo, el estudiante debe realizar un escrito y allegarlo al día siguiente con la firma del padre, madre y/o acudiente, donde conste que se encuentra enterado de la situación.

• El coordinador remitirá de manera inmediata a las entidades competentes.

• El coordinador rendirá informe inmediatamente sobre la situación al Rector (Presidente del Comité Escolar de Convivencia), quien citará de manera inmediata y por el medio más expedito al Comité Escolar de Convivencia, padres, madres y/o acudientes de los estudiantes involucrados para presentar el caso y activar la Ruta de Atención Integral (RAI).

• El Comité Escolar de Convivencia tomará las medidas pertinentes de protección y hará el seguimiento de la situación.`
},

{
    titulo: "Artículo Veintiséis. Acciones preventivas y/o correctivas a tomar para situaciones Tipo III",
    palabras: [
        "artículo veintiséis",
        "articulo veintiseis",
        "veintiséis",
...
Se informará oportunamente al padre o acudiente la situación presentada y quedará constancia en el Observador.

SUSPENSIÓN DE UNO A TRES DÍAS

Es una medida de carácter formativo donde el estudiante no podrá asistir a las clases regulares durante un periodo determinado por el Comité de Convivencia. Esta busca la reflexión en el estudiante con el fin de que mejore su comportamiento.

El incumplimiento de los compromisos disciplinarios o el incurrir en situaciones catalogadas como Tipo II o III en el presente Manual de Convivencia dará lugar a la suspensión de uno a tres días, previo análisis del Comité de Convivencia.

Durante la suspensión, el alumno no podrá participar de las actividades regulares del Colegio, asumiendo todas las consecuencias académicas que se deriven de ello. Deberá retornar a la institución con los cuadernos al día correspondientes a las clases a las que dejó de asistir debido a la sanción.

En este caso, el alumno comparecerá ante el Comité de Convivencia para dar su versión de los hechos y realizar los descargos que considere pertinentes. Previamente, el Comité de Convivencia recogerá toda la información sobre el hecho, escuchará al estudiante e informará a la familia. Así mismo, el Comité de Convivencia presentará toda la información que se haya recogido previamente sobre los hechos.

Cuando se determine aplicar esta sanción, se levantará un acta de la medida de suspensión, de la cual se entregará copia a los padres del alumno.

En todos los casos de suspensión, el estudiante deberá realizar una reflexión escrita sobre su comportamiento, analizando los factores que lo llevaron a incurrir en actos tipificados como situaciones Tipo II o III, las consecuencias y los compromisos de cambio que asumirá.

En el Observador se consignarán los compromisos de mejoramiento asumidos por el estudiante y el apoyo que recibirá de sus padres en el cumplimiento de dicho compromiso. La nota de comportamiento del estudiante implicado se verá afectada por estos hechos.

Causales de suspensión:

1. Reincidencia en faltas Tipo II o III, teniendo matrícula condicional o acta de compromiso.
2. Incumplimiento reiterado de sus compromisos.

PÉRDIDA DE CUPO

Agotadas las instancias y el seguimiento en busca de un mejor comportamiento en el estudiante y con el propósito de garantizar una sana convivencia, el Comité de Convivencia y el Consejo Directivo determinarán la cancelación de la matrícula.

Esta será comunicada por Rectoría y Coordinación al incurrir el estudiante en cualquiera de las situaciones Tipo II o Tipo III.

También son causales de pérdida de cupo las siguientes:

• Pérdida de año por dos veces consecutivas durante su permanencia en la institución.
• Incumplimiento constante de sus compromisos académicos.
• Inasistencia constante.`
},
{
    titulo: "Artículo Veintisiete. Comité Institucional de Convivencia Escolar",
    palabras: [
    ...
    contenido: `Artículo Veintisiete. Comité Institucional de Convivencia Escolar.

De acuerdo con lo establecido por la ley, es la máxima instancia en el manejo, orientación y activación de la ruta para la atención de los casos que afectan la convivencia escolar en la Institución Educativa Delicias - San Carlos, constituido por los estamentos establecidos en la norma.

Su tarea será apoyar la labor de promoción y seguimiento a la convivencia escolar, a la educación para el ejercicio de los derechos humanos, sexuales y reproductivos, así como el desarrollo y aplicación del Manual de Convivencia y de la prevención y mitigación de la violencia escolar.
...
{
    titulo: "Artículo Veintiocho. Funciones del Comité de Convivencia Escolar y sus miembros",
    palabras: [
        "artículo veintiocho",
        "articulo veintiocho",
        "veintiocho",
    ...
    contenido: `Artículo Veintiocho. Funciones del Comité de Convivencia Escolar y sus miembros.

Acorde con lo establecido por la Ley 1620 de 2013, Decreto reglamentario 1965 de 2013 y Manual de Convivencia, se adoptan las siguientes funciones:
...
5. Activar la Ruta de Atención Integral para la Convivencia Escolar definida en el artículo 29 de la Ley 1620 de 2013, frente a situaciones específicas de conflicto, de acoso escolar, frente a las conductas de alto riesgo de violencia escolar o de vulneración de derechos sexuales y reproductivos que no pueden ser resueltos por este comité porque trascienden del ámbito escolar y revistan las características de la comisión de una conducta punible.

6. Liderar el desarrollo de estrategias e instrumentos destinados a promover y evaluar la convivencia escolar y el ejercicio de los derechos humanos, sexuales y reproductivos.

7. Hacer seguimiento al cumplimiento de las disposiciones establecidas en el Manual de Convivencia y presentar informes a la respectiva instancia que hace parte de la estructura del Sistema Nacional de Convivencia Escolar sobre los casos o situaciones que haya conocido el comité.

8. Proponer, analizar y viabilizar estrategias pedagógicas que permitan la flexibilización del modelo pedagógico y la articulación de diferentes áreas de estudio que lean el contexto educativo y su pertinencia en la comunidad para determinar más y mejores maneras de relacionarse en la construcción de la ciudadanía.`
},
{
    titulo: "Artículo Veintinueve. Acciones de Promoción",
    palabras: [
    ...
    contenido: `Artículo Veintinueve. Acciones de Promoción.
...
- Liderar iniciativas a través de talleres, orientados por la Personería Municipal, Defensoría del Pueblo y Comisaría de Familia, en formación de la comunidad educativa en temáticas tales como derechos humanos, mediación y conciliación, para fortalecer el Sistema Institucional de Convivencia Escolar.
- Fortalecer la implementación de proyectos pedagógicos de educación para la sexualidad y construcción de ciudadanía desde preescolar, que correspondan a las particularidades socioculturales locales y departamentales.
- Desarrollar progresivamente, por medio de alianzas con entidades, competencias que faciliten la toma de decisiones autónomas frente al ejercicio de la sexualidad y la realización de proyectos de vida.`
},

{
    titulo: "Artículo Treinta. Acciones de Atención",
    palabras: [
        "artículo treinta",
        "articulo treinta",
        "treinta",
    ...
    contenido: `Artículo Treinta. Acciones de Atención.
...
{
    titulo: "Artículo Treinta y Uno. Acciones de Prevención",
    palabras: [
    ...
    contenido: `Artículo Treinta y Uno. Acciones de Prevención.
...
- La identificación de los riesgos de ocurrencia de las situaciones más comunes que afectan la convivencia escolar y el ejercicio de los derechos humanos, sexuales y reproductivos, a partir de las particularidades del clima escolar y del análisis de las características familiares, sociales, políticas, económicas y culturales externas de la institución que inciden en las relaciones interpersonales de la comunidad educativa.
- El diseño e implementación de acciones pedagógicas como charlas, talleres, conferencias y diálogos, entre otras, que contribuyan a la mitigación de las situaciones que estén afectando la convivencia escolar y el ejercicio de los derechos humanos, sexuales y reproductivos en los niños, niñas y jóvenes de la Institución.

Parágrafo: Pérdida del cupo. Teniendo en cuenta lo normado en la Ley General de Educación y sentencias de la Corte Constitucional, el estudiante que luego de reprobar dos o más veces un grado perderá el cupo de manera automática.`
},

{
    titulo: "Artículo Treinta y Dos. Gobierno Escolar",
    palabras: [
    ...
    contenido: `Artículo Treinta y Dos. Gobierno Escolar.

Definición: Se define como el conjunto de personas y órganos encargados de la orientación, dirección y administración de la institución educativa. Estos órganos de gobierno se constituyen posibilitando la participación democrática de todos los estamentos de la comunidad educativa de la institución, de acuerdo con el artículo 142 de la Ley 115 de 1994.

De acuerdo con la Ley General de Educación y el artículo 18 del Decreto 1860 de 1994, la comunidad educativa está constituida por las personas que tienen responsabilidades directas en la organización, desarrollo y evaluación del Proyecto Educativo que se ejecuta en la Institución Educativa.
...
Todos ellos son competentes para participar en la dirección de las instituciones de educación y lo harán por medio de sus representantes en los órganos del gobierno escolar.
...
{
    titulo: "Artículo Treinta y Tres. Funciones del Consejo Directivo",
    palabras: [
    ...
    contenido: `Artículo Treinta y Tres. Funciones del Consejo Directivo.
...
2. Servir de instancia para resolver los conflictos que se presenten entre los docentes y administrativos con los estudiantes del establecimiento educativo, después de haber agotado los procedimientos previstos en el reglamento o Manual de Convivencia.
...
7. Participar en la planeación y evaluación del Proyecto Educativo Institucional, del currículo y del plan de estudios y someterlos a consideración de la Secretaría de Educación respectiva o del organismo que haga sus veces.
...

{
    ...
    contenido: `Artículo Treinta y Cuatro. Funciones del Consejo Académico.
...
2. Estudiar el currículo y propiciar su continuo mejoramiento, introduciendo las modificaciones y ajustes de acuerdo con el mismo decreto.
...
Con respecto a la organización institucional para la evaluación, el Consejo Académico tiene las siguientes funciones:

8. Aprobar el sistema institucional de evaluación, de acuerdo con el numeral 1 del artículo 11 del Decreto 1290.
...

{
    ...
    contenido: `Artículo Treinta y Cinco. Funciones del Rector.
...

{
    ...
    contenido: `Artículo Treinta y Seis. Representante de los Estudiantes ante el Consejo Directivo.

El representante de los estudiantes es un vocero que defiende los intereses de los estudiantes, hará cumplir sus derechos y velará por el cumplimiento de sus deberes dentro de la institución. Tiene voz y voto, es decir, tiene poder decisorio y deberá ser tenido en cuenta en sus exposiciones.

En cuanto a la elección, se procede de la siguiente manera: se escogen varios aspirantes del grado undécimo, mínimo dos, y será escogido por el consejo estudiantil en reunión ordinaria mediante elección democrática.`
},

{
    ...
    palabras: [
        ...
        "programas de proyección institucional",
        "conciliador"
    ],
    contenido: `Artículo Treinta y Siete. Funciones del Representante de los Estudiantes ante el Consejo Directivo.

1. Mantener la organización activa de los estudiantes mediante el consejo estudiantil para recoger las inquietudes y llevarlas al consejo directivo para su debate.
2. Representar con altura y decoro el cargo.
3. Elaborar propuestas que contribuyan al mejoramiento de la institución.
4. Mantener una comunicación permanente con los estudiantes, presentando informes sobre las últimas deliberaciones del consejo directivo.
5. Analizar conjuntamente con el consejo estudiantil las decisiones tomadas en el consejo directivo.
6. Liderar los programas de proyección institucional.
...
const articulo38 = {
    ...
    contenido: `
El Consejo de Estudiantes es el máximo órgano colegiado que asegura y garantiza el continuo ejercicio de la participación por parte de los alumnos. Estará integrado por un vocero de cada uno de los grupos desde los grados tercero a undécimo.

El Consejo Directivo, por medio del Comité Civismo, Paz y Democracia, convocará dentro de los treinta días calendario a reuniones de los alumnos de estos cursos, con el fin de que elijan mediante votación secreta un vocero para el año lectivo en curso.
`
};
...
1. Escoger de terna al estudiante de grado undécimo que los representará en el Consejo Directivo.
2. Contribuir en la solución de las situaciones que afecten a la institución.
3. Analizar las inquietudes que presenten los estudiantes por medio de su vocero y darles el tratamiento correspondiente.
4. Plantear ante los directivos las inquietudes presentadas por los estudiantes en materia académica y de aplicación de las normas del Manual de Convivencia.
...
const articulo40 = {
    ...
    contenido: `
El Personero Escolar es un estudiante de grado undécimo de la institución que se encargará de promover el ejercicio de los deberes y derechos de los estudiantes consagrados en la Constitución Política, las leyes, los reglamentos y el Manual de Convivencia.
`
};

const articulo41 = {
    titulo: "Artículo Cuarenta y Uno - Funciones del Personero Escolar",
    palabras: [
        "articulo 41",
    ...
    contenido: `
Son funciones del Personero Escolar:

1. Promover el cumplimiento de los derechos y deberes de los estudiantes, utilizando los medios de comunicación interna del establecimiento, solicitando la colaboración del Consejo de Estudiantes y organizando foros u otras formas de deliberación.
2. Recibir y evaluar las quejas y reclamos que presenten los educandos sobre lesiones a sus derechos y las que formule cualquier persona de la comunidad sobre el incumplimiento de las funciones de los alumnos.
...
El Personero de los estudiantes será un alumno de grado undécimo con alto desempeño académico y disciplinario, con una estadía mínima de dos años en la institución. Será elegido dentro de los treinta días calendario siguientes al inicio de clases de un periodo lectivo anual, mediante voto secreto.

En caso de empate entre los candidatos, se realizará el procedimiento establecido por la institución para determinar al estudiante elegido.
`
};
...
const articulo42 = {
    ...
    contenido: `
La figura del Contralor Escolar fue creada como un mecanismo de promoción y fortalecimiento del control social en la gestión educativa y como espacio de participación de los jóvenes para promover la transparencia y la vigilancia de los recursos y bienes públicos.

El Contralor o Contralora Escolar será un estudiante de grado noveno, décimo u undécimo con alto desempeño académico y disciplinario, con una estadía mínima de dos años en la institución. Su elección coincidirá con la del Personero Escolar y se realizará mediante voto secreto.
...
const articulo43 = {
    ...
    contenido: `
Son funciones del Contralor Escolar:
...
4. Ejercer control social a los procesos de contratación que realice la institución educativa.
5. Canalizar las inquietudes de la comunidad educativa sobre deficiencias o irregularidades en el presupuesto o en el manejo de los bienes de la institución educativa.
...
7. Poner en conocimiento del organismo de control competente las denuncias que tengan mérito para que se realicen los procedimientos de investigación y sanción correspondientes.
...
]
{
    ...
    contenido: `
El Consejo de Padres de Familia, como órgano de la asociación de padres, es un medio para asegurar la continua participación de los padres y acudientes en el proceso de formación de sus hijos.

Estará integrado por los representantes de los padres de los alumnos que cursan cada uno de los diferentes cursos de cada grado que ofrece la institución.

Dentro de los treinta días calendario siguientes a la iniciación de clases, los directores de grupo convocarán reuniones para la escogencia del representante, quien será elegido democráticamente mediante el voto por el sistema de mayoría simple, para una vigencia de un año lectivo. Si cumplido el año no se ha elegido un nuevo representante, este continuará hasta que la nueva elección se haga efectiva.
`
},
{
    titulo: "Artículo Cuarenta y Cinco - Funciones del Consejo de Padres",
    palabras: [
        "articulo 45",
...
1. Estar pendiente del proceso formativo de los alumnos.
2. Motivar al alumnado del grupo que representa hacia el estudio y las buenas costumbres.
3. Reunirse con el grupo para conocer sus inquietudes y problemáticas.
4. Hacer sugerencias a los docentes y directivos docentes sobre cómo mejorar las dificultades que se presenten en el desarrollo del proceso de formación.
5. Escuchar con paciencia y respeto a los alumnos del grupo que representa.
6. Ser mediador en la solución de conflictos que se presenten entre los estudiantes.
7. Representar al curso del grado ante las comisiones de evaluación y promoción.
`
},
{
    ...
    contenido: `
El Sistema Institucional de Evaluación de Estudiantes (SIEE) es el conjunto de procedimientos y estrategias que garantizan la evaluación del proceso de enseñanza y aprendizaje de acuerdo con el modelo pedagógico Constructivista-Dialógico de la Institución Educativa y con las normas legales vigentes, especialmente el Decreto 1290 de 2009.

El Equipo de Dirección junto con el Consejo Académico establecerá un calendario para que, al iniciar el año escolar, los maestros, estudiantes y padres de familia conozcan en detalle la estructura y composición del SIEE.

Es obligación del estudiante cumplir con los compromisos académicos y de convivencia, así como con las estrategias recomendadas por sus maestros para superar las dificultades y mejorar su desempeño.

La evaluación será integral y se expresará de manera comprensible para maestros, estudiantes y padres de familia en cada asignatura.

La evaluación permitirá comparar permanentemente el estado formativo y cognitivo de los estudiantes con el perfil definido en el PEI. La evaluación comprende modalidades diagnósticas, formativas y sumativas.

Las comisiones de evaluación y promoción tienen como función garantizar el seguimiento de los procesos de evaluación de acuerdo con la ley y el reglamento interno; analizar el rendimiento académico y la vivencia de valores de los estudiantes por periodo y al finalizar el año escolar; determinar estímulos y estrategias de apoyo, refuerzo y superación; establecer mecanismos de seguimiento y verificar el cumplimiento del proceso académico establecido.
`
},
{
    ...
    contenido: `
Los componentes de evaluación constituyen el conjunto de criterios y actividades con los cuales se evalúa el desempeño de los estudiantes. Se concretan mediante dos tipos de acciones: las actividades cotidianas y las pruebas formales de desempeño.

Las actividades cotidianas están constituidas por el trabajo desarrollado por el estudiante dentro y fuera de la clase, incluyendo trabajos en aula y en casa.

Las pruebas formales de desempeño son evaluaciones o exámenes mediante los cuales se determina el proceso de aprendizaje del estudiante en los aspectos básicos y fundamentales.

Las actividades cotidianas, como tareas, talleres, pruebas orales o escritas y trabajos en clase, se agrupan en periodos académicos y se complementan con un examen final.

Los porcentajes correspondientes son determinados por el Consejo Académico al iniciar el año escolar.

El proceso de evaluación académica, de formación y de comportamiento incluye ejercicios de heteroevaluación, autoevaluación y coevaluación.

Al finalizar cada periodo académico se entregará un reporte sobre el rendimiento y comportamiento de cada estudiante. Con el informe del último periodo se anexa un informe consolidado con el resultado final de cada asignatura según la escala valorativa nacional.

La plataforma de notas es el mecanismo de comunicación para mantener informados a los padres de familia y a los estudiantes sobre su rendimiento académico y disciplinario.
...
const articuloCuarentaYOcho = {
  ...
  contenido: `Cuando se evidencien situaciones que no favorezcan el buen desempeño y la obtención de buenas calificaciones, la institución organizará ejercicios o actividades que faciliten la nivelación de los estudiantes.
...
const articuloCuarentaYNueve = {
  ...
  contenido: `De acuerdo con lo establecido por la ley y los criterios de atención institucional, los padres de familia y los estudiantes tienen el derecho y las garantías necesarias para que sus observaciones, peticiones, alegatos y demás sean atendidas de manera eficiente y oportuna por maestros y demás funcionarios de la institución, siempre dentro de los parámetros del respeto y cordialidad debidas.
...
const articuloCincuenta = {
  ...
  contenido: `Se entiende por promoción el acto decisorio mediante el cual se establece que un(a) estudiante ha alcanzado el desempeño mínimo básico en su proceso de aprendizaje, que le garantiza asumir con propiedad los compromisos del grado inmediatamente superior. En el caso de undécimo grado se traduce en la obtención del título de bachiller Técnico en Sistemas. Cuando los requisitos no se cumplen, la comisión de Evaluación puede determinar la reprobación u aplazamiento de grado.
...
const articuloCincuentaYcinco = {
  ...
  contenido: `Se refiere a todo impedimento en la asistencia normal del estudiante y el cumplimiento en el desarrollo de las actividades académicas dentro y fuera de la institución, para garantizarle el pleno derecho a asistir y realizar todo tipo de actividades programadas en cada una de las asignaturas contempladas en el plan de estudios vigentes en la institución. Se prevén tres formas de excusas:

1. Excusas familiares: Son aquellas que envía el padre de familia o acudiente del estudiante para comunicar a la institución que el joven o la joven no podrá asistir a la misma por razones de salud, de viaje, calamidad familiar o imprevistos presentados a última hora. Este tipo de excusa sólo ampara los compromisos de la jornada para la cual fue enviada. Cuando se trata de problemas de salud, esta misma excusa podrá extenderse con el visto bueno de la coordinación máximo hasta por dos días.

Esta excusa debe ser enviada por los padres o una persona mayor que conviva en el mismo núcleo familiar, debidamente presentada y dirigida al coordinador.

2. Excusas médicas: Cuando el estudiante lleva más de dos días de inasistencia por razones de mal estado de salud, deberá presentar a la coordinación una excusa médica en donde se dé plena constancia del cuadro clínico que presenta, para que pueda presentar las actividades dejadas de presentar por su ausencia. Para ello deberá presentarse ante el o los profesores para acordar las fechas en las cuales ejecutará las tareas pendientes. Este diálogo deberá darse dentro de las 48 horas siguientes a su retorno al colegio.

Cuando por razones de salud se impida la realización de ejercicios físicos en el área de educación física y deportes, el estudiante deberá presentar excusa médica expedida por médico especialista para la supresión definitiva o parcial de dichas actividades. El docente deberá asignarle otras actividades diferentes que no le afecten su organismo, enmarcadas dentro del plan de actividades del área respectiva.

3. Excusas deportivas: Cuando el estudiante presente inasistencia por razones deportivas institucionales, las actividades dejadas de presentar por su ausencia deberá acordarlas con los profesores. Este diálogo deberá darse dentro de las 48 horas siguientes a su retorno.`
};
const articuloCincuentaYSeis = {
  ...
  contenido: `Los padres de familias de la Institución Educativa Delicias-San Carlos tienen los siguientes deberes:

Recibir información permanente sobre el proceso de formación de su hijo o hija, para lo cual deberá asistir cada vez que se le convoque y cuando así lo considere.
...
Cancelar oportunamente los costos educativos contemplados en el contrato de matrícula.
...
const articuloCincuentaYSiete = {
  ...
  contenido: `Son derechos de los padres de familias:
...
const articuloCincuentaYOcho = {
  ...
  contenido: `Los docentes tienen los siguientes derechos:
...
Permanecer en el servicio y no ser desvinculado o sancionado, sino de acuerdo con las normas y procedimientos vigentes.
...
const articuloCincuentaYNueve = {
  ...
  contenido: `Cumplir la Constitución y las leyes de Colombia.
...
const articuloSesenta = {
  ...
  palabras: [
    ...
    "prohibiciones docentes",
    "docentes",
    "profesores"
  ],
  contenido: `Abandonar y suspender las labores injustificadamente o sin autorización previa.
...
const articuloSesentaYUno = {
  ...
  contenido: `Se considera estímulo toda motivación o acto de reconocimiento a las personas que dentro y fuera de la institución se han destacado positivamente en el desarrollo de las distintas actividades del proceso de formación. También se define como el premio que debe recibir un docente o administrativo por el alto grado de responsabilidad, compromiso, profesionalismo y ética con el que ha asumido el desempeño de sus funciones.

La institución ha definido las siguientes valoraciones para determinar los estímulos:
...
const articuloSesentaYTres = {
  ...
  contenido: `Este Manual de Convivencia se divulgará a través del diario discurrir de las actividades escolares por medio de los profesores, directores de grupo, por los directivos, por los representantes de los padres de familias, por el personero y por los representantes del consejo estudiantil.
...
const articuloSesentaYCuatro = {
  ...
  contenido: `Todos los entes que conforman esta comunidad educativa tienen responsabilidades en la aplicación de este Manual de Convivencia, dado que su fin es lograr una sana convivencia entre sus miembros.
...
const articuloSesentaYCinco = {
  ...
  contenido: `El presente Acuerdo rige a partir de la fecha de su aprobación y deroga las disposiciones contempladas en el Manual de Convivencia anterior a la publicación de éste.

Dado en El Copey a los 25 días del mes de septiembre del año 2017.
